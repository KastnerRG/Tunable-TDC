...
set DataType00 "[list ap_uint 144 ]"
...
set structArgument0 [list 144 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<144>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "stateOut"
set BitWidth1 "128"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1 [list "ap_axiu<64>" "struct ap_axiu" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
