...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module present_rounds_sbcud_rom (
...
initial begin
    $readmemh("./present_rounds_sbcud_rom.dat", ram0);
    $readmemh("./present_rounds_sbcud_rom.dat", ram1);
    $readmemh("./present_rounds_sbcud_rom.dat", ram2);
    $readmemh("./present_rounds_sbcud_rom.dat", ram3);
end
...
present_rounds_sbcud_rom present_rounds_sbcud_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
