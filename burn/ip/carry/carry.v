...
module carry
    ...
    (* keep = "true" *) reg [C_OUT_WIDTH:0]              rSync[C_SYNC_DEPTH-1:0];
    reg [C_OUT_WIDTH:0]              rCounter;
    wire [C_OUT_WIDTH:0]             wSyncEnd;
    wire [C_OUT_WIDTH:0]             wSyncEndM1;
    always @(posedge M_AXIS_ACLK) begin
        rSync[0] <= {wResult[C_OUT_WIDTH-1:0], S_AXIS_TVALID};
    end
    ...
    assign M_AXIS_TDATA = wSyncEnd[C_OUT_WIDTH:1];
    assign M_AXIS_TVALID = wSyncEnd[0];
    assign M_AXIS_TLAST = (wSyncEnd[0] == 1) && (wSyncEndM1[0] == 0);
