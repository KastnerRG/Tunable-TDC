...
proc create_hier_cell_processor { parentCell nameHier } {
  ...
  connect_bd_net -net picorv32_trap [get_bd_pins picorv32/trap] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins irq] [get_bd_pins xlslice_0/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: resetSlice1, and set properties
  set resetSlice1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 resetSlice1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {7} \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs processor/psBramController/S_AXI/Mem0] SEG_psBramController_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x83C20000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs chain0/pulsegen/s_axi_CNTRL/Reg] SEG_pulsegen_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x81200000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs chain0/resetGpio/S_AXI/Reg] SEG_resetGpio_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs subprocessorClk/s_axi_lite/Reg] SEG_subprocessorClk1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x83C40000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs bumper/target_sensor_clock/s_axi_lite/Reg] SEG_target_sensor_clock_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces chain0/dataDma/Data_S2MM] [get_bd_addr_segs processing_system7_1/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_1_HP1_DDR_LOWOCM
